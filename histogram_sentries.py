...
file_path = 'sentries/by-NFT.json'
...
def plot_nft_ownership_histogram(nft_data, bins=30):
    ...
    for nft in nft_data:
        ...
        if holder not in ["Magic Eden V2 Authority", "4zdNGgAtFsW1cQgHqkiWyRsxaAgxrSRRynnuunxzjxue", "1BWutmTvYPwDtmw9abTkS4Ssr8no61spGAvW1X6NDix", "GxHbdbN36AG4XKqkpf4AsBF3WFa193wWHYGkfXHGZM28" ] and when_acquired and is_valid_unix_timestamp(when_acquired):
    ...
    save_path = 'sentries/histogram.png'
