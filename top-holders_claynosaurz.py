...
with open('claynosaurz/ranked-holders.json') as f:
    data = json.load(f)[:20]
...
ax3.xaxis.set_minor_formatter(custom_formatter)
...
fig.tight_layout()
plt.savefig('claynosaurz/top-holders.png', format='png', bbox_inches='tight')
