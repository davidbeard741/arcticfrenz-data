...
`arcticfrenz/by-holder.json` JSON file containing data on holders.

### Output

`arcticfrenz/ranked-holders.json` JSON file containing the ranked list of holders based on their calculated score.
...
| **The total number of NFTs owned by the individual with the largest NFT collection** | 50 |
| **The average rarity score of the owner who possesses the highest average rarity score** | 0.5327891539170311 |
| **The total duration held by the owner possessing the maximum cumulative duration of all NFTs they own** | 24947 |
| **Average Score of Holder's NFTs Owned** | 0.08769230769230772 |
| **Average Score of Holder's Rarity** | 0.06312570461015997 |
| **Average Score of Holder's Days Held** | 0.08264911123766255 |
...
try:
    with open('arcticfrenz/by-holder.json') as f:
        data = json.load(f)
    ...
    with open('arcticfrenz/ranked-holders.json', 'w') as f:
