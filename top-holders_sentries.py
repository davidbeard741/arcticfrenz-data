...
with open('sentries/ranked-holders.json') as f:
    data = json.load(f)[:20]
...
ax.tick_params(axis='x', labelsize=0, which='both', bottom=False, top=False, labelbottom=False)
ax.invert_yaxis()
...
fig.tight_layout()
plt.savefig('sentries/top-holders.png', format='png', bbox_inches='tight')
